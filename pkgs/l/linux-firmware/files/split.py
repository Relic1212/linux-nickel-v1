...
needed = [
    ...
    "iwlwifi-bz-a0-fm-b0-90.ucode",
    "iwlwifi-bz-a0-fm-c0-90.ucode",
    "iwlwifi-bz-a0-fm4-b0-90.ucode",
    "iwlwifi-bz-a0-gf-a0-90.ucode",
    "iwlwifi-bz-a0-gf4-a0-90.ucode",
    "iwlwifi-bz-a0-hr-b0-90.ucode",
    "iwlwifi-cc-a0-77.ucode",
    "iwlwifi-gl-b0-fm-b0-90.ucode",
    ...
    "iwlwifi-sc-a0-fm-b0-90.ucode",
    "iwlwifi-sc-a0-fm-c0-90.ucode",
    "iwlwifi-sc-a0-gf-a0-90.ucode",
    "iwlwifi-sc-a0-gf4-a0-90.ucode",
    "iwlwifi-sc-a0-hr-b0-90.ucode",
    "iwlwifi-sc-a0-wh-a0-90.ucode",
    "iwlwifi-sc2-a0-fm-c0-90.ucode",
    "iwlwifi-sc2-a0-wh-a0-90.ucode",
    "iwlwifi-sc2f-a0-fm-c0-90.ucode",
    "iwlwifi-sc2f-a0-wh-a0-90.ucode",
    ...
    "nvidia/ad103/gsp/booter_load-535.113.01.bin",
    "nvidia/ad103/gsp/booter_unload-535.113.01.bin",
    "nvidia/ad103/gsp/bootloader-535.113.01.bin",
    "nvidia/ad103/gsp/gsp-535.113.01.bin",
    "nvidia/ad104/gsp/booter_load-535.113.01.bin",
    "nvidia/ad104/gsp/booter_unload-535.113.01.bin",
    "nvidia/ad104/gsp/bootloader-535.113.01.bin",
    "nvidia/ad104/gsp/gsp-535.113.01.bin",
    "nvidia/ad106/gsp/booter_load-535.113.01.bin",
    "nvidia/ad106/gsp/booter_unload-535.113.01.bin",
    "nvidia/ad106/gsp/bootloader-535.113.01.bin",
    "nvidia/ad106/gsp/gsp-535.113.01.bin",
    "nvidia/ad107/gsp/booter_load-535.113.01.bin",
    "nvidia/ad107/gsp/booter_unload-535.113.01.bin",
    "nvidia/ad107/gsp/bootloader-535.113.01.bin",
    "nvidia/ad107/gsp/gsp-535.113.01.bin",
    ...
    "nvidia/ga103/gsp/booter_load-535.113.01.bin",
    "nvidia/ga103/gsp/booter_unload-535.113.01.bin",
    "nvidia/ga103/gsp/bootloader-535.113.01.bin",
    "nvidia/ga103/gsp/gsp-535.113.01.bin",
    ...
    "nvidia/ga104/gsp/booter_load-535.113.01.bin",
    "nvidia/ga104/gsp/booter_unload-535.113.01.bin",
    "nvidia/ga104/gsp/bootloader-535.113.01.bin",
    "nvidia/ga104/gsp/gsp-535.113.01.bin",
    ...
    "nvidia/ga106/gsp/booter_load-535.113.01.bin",
    "nvidia/ga106/gsp/booter_unload-535.113.01.bin",
    "nvidia/ga106/gsp/bootloader-535.113.01.bin",
    "nvidia/ga106/gsp/gsp-535.113.01.bin",
    ...
    "nvidia/tu104/gsp/booter_load-535.113.01.bin",
    "nvidia/tu104/gsp/booter_unload-535.113.01.bin",
    "nvidia/tu104/gsp/bootloader-535.113.01.bin",
    "nvidia/tu104/gsp/gsp-535.113.01.bin",
    ...
    "nvidia/tu106/gsp/booter_load-535.113.01.bin",
    "nvidia/tu106/gsp/booter_unload-535.113.01.bin",
    "nvidia/tu106/gsp/bootloader-535.113.01.bin",
    "nvidia/tu106/gsp/gsp-535.113.01.bin",
    ...
    "nvidia/tu117/gsp/booter_load-535.113.01.bin",
    "nvidia/tu117/gsp/booter_unload-535.113.01.bin",
    "nvidia/tu117/gsp/bootloader-535.113.01.bin",
    "nvidia/tu117/gsp/gsp-535.113.01.bin",
...
fw_base="/tmp/workdir/out/destdir/lib/firmware"
for r, _, fs in os.walk(fw_base):
    for f in fs:
        fp = f"{r}/{f}"
        b = False # whether this particular fw file is needed
        for n in needed:
            if fp.endswith(n):
                b = True
        if fp.replace(f"{fw_base}/","") in needed:
            b=True
        for elem in [ p.split("*")[0] for p in  needed]:

            if fp.replace(f"{fw_base}/","").startswith(elem):
                b=True
        if not b:
            base = os.path.dirname(fp).replace("/tmp/workdir/out/destdir/lib/firmware","/tmp/workdir/out/destdir/lib/firmware.unneeded")
            # fwdest=f"/tmp/workdir/build/{base}"
            fwdest=base
            os.makedirs(fwdest,exist_ok=True)
            subprocess.run(["mv", fp, fwdest  ],check=True)


print("all firmare has now been moved")
