...
const char* lib__usr_lib_valadoc_0_56_doclets_html_libdoclet_so = "lib__usr_lib_valadoc_0_56_doclets_html_libdoclet_so";

void* dlopen(const char *path, int mode) {
	if (path == NULL) { return &main_program_handle; }
	if (strcmp( path, "/usr/lib/valadoc-0.56/doclets/html/libdoclet.so" ) == 0) { dbg_print("(dlopen) found library /usr/lib/valadoc-0.56/doclets/html/libdoclet.so (handle=%p)\n", &lib__usr_lib_valadoc_0_56_doclets_html_libdoclet_so); return &lib__usr_lib_valadoc_0_56_doclets_html_libdoclet_so; }
...
void* dlsym(void *__restrict handle, const char *__restrict symbol) {
	if (handle == &lib__usr_lib_valadoc_0_56_doclets_html_libdoclet_so || handle == NULL || handle == &main_program_handle) { 
		DLSYM(register_plugin, )
		DLSYM(valadoc_html_doclet_construct, )
		DLSYM(valadoc_html_doclet_get_type, )
		DLSYM(valadoc_html_doclet_new, )
	}
