...
void* dlsym(void *__restrict handle, const char *__restrict symbol) {
    ...
    DLSYM(wofi_dmenu_exec, );
    DLSYM(wofi_dmenu_get_arg_count, );
    DLSYM(wofi_dmenu_get_arg_names, );
    DLSYM(wofi_dmenu_get_widget, );
    DLSYM(wofi_dmenu_init, );
    DLSYM(wofi_dmenu_no_entry, );

    DLSYM(wofi_drun_exec, );
    DLSYM(wofi_drun_get_arg_count, );
    DLSYM(wofi_drun_get_arg_names, );
    DLSYM(wofi_drun_get_widget, );
    DLSYM(wofi_drun_init, );
    // DLSYM(wofi_drun_no_entry, );

    DLSYM(wofi_run_exec, );
    DLSYM(wofi_run_get_arg_count, );
    DLSYM(wofi_run_get_arg_names, );
    DLSYM(wofi_run_get_widget, );
    DLSYM(wofi_run_init, );
    DLSYM(wofi_run_no_entry, );
